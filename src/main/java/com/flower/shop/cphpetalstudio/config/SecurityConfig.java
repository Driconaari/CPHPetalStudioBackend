    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    corsConfiguration.setAllowedOrigins(java.util.List.of("http://localhost:5500", "https://cphpetalstudio-frontend.azurewebsites.net" )); // Allow frontend to make request
